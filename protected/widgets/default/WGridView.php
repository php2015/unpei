...
Yii::import('widgets.default.WDataColumn');

/**
 * Bootstrap Zii grid view.
 */
class WGridView extends CGridView {
    ...
    protected function initColumns() {
        foreach ($this->columns as $i => $column) {
            if (is_array($column) && !isset($column['class'])) {
                $this->columns[$i]['class'] = 'widgets.default.WDataColumn';
            }
        }
        parent::initColumns();
    }
     ...
     * @return \WDataColumn|\CDataColumn the column instance
