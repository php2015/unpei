<style>
    .selected { background:#39AE39; color: #fff;}
    ...
    .selectBig{background: #fff;clear:both; overflow:auto;border:1px solid #39AE39;position: absolute; width:725px; float:left; z-index: 11500;}
    .selectBig2{background: #fff;clear:both;border:1px solid #39AE39;position: absolute; width:725px; float:left; z-index: 11500}
    ...
    .Bigname_list{float:left;border:1px solid #DEDEDC; margin-left:5px;width:190px;height:235px;margin-bottom:10px;}
    .cpnamelist ul li{
        line-height: 24px;
        list-style: none outside none;
        margin-bottom: 1px;}
    .cpnamelist ul li:hover{background:#38AF39}
    ...
    .Somname_list{float:left;border:1px solid #DEDEDC; width:195px; height:235px;margin-bottom:10px;}
    .cpnamelist .next_name{ float:right; color:#C4C4C4; font-weight:bolder}
    /* 标准名称*/
    .select_BiaoName{   background: none repeat scroll 0 0 #FFFFFF;
                        ...
                        width: 310px;
                        z-index: 500;}
    .cpnameleft_A ul li{ border:1px solid #e1e1e1; width:14px; height:14px; background:#E5FBE6; margin-bottom:1PX; }
    .cpnameleft_A ul li a{color:#3FB138;font:12px Arial; padding-left:3px; display:block; float:left;width:12px; height:14px;}
    .cpnameleft_A ul li a:hover{background:#39AE39; color:white}



    .select_BiaoName{ height:282px; border-left: none}
        ...
        $("#ul-bigcate .li_list").click(function(){
            ...
            $.getJSON(urlsub, data, function(result){
                ...
                $.each(result,function(index,value){
                    var li= '<li class="li_list"><a key='+ value.id+' href="javascript:void(0)">'+value.name+'</a><span class="next_name">></span></li>';
                    ...
                    $.each(first.children,function(index,value){
                        if(index == 0){
                            if(typeof(value.name) != 'undefined'){
                                ...
                                li += '<a class="li_list" key='+ value.id+' href="javascript:void(0)">'+value.name+'</a>';
                            }  
                        }else{
                            if(typeof(value.name) != 'undefined'){
                                // li+= '<li class="li_list"><a key='+ value.modelId+' name='+year.year+' href="javascript:void(0)">'+value.name+'</a></li>';
                                li += '<label class="line"> |</label><a class="li_list" key='+ value.id+' href="javascript:void(0)">'+value.name+'</a>';
                            }  
                        }
