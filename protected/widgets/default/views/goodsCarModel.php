        ...
        <div class="selectpop ass-items" style="clear:both; overflow:auto;">
            ...
            <div class="car_brand" style=" clear:both; overflow:auto;">
                ...
                <div class="left_A" style="float:left;">
                    <ul style="list-style:none; margin:0;padding-left:10px;  overflow:hidden" >
                        <?php
    ...
    $(function() {
        ...
        $("#ul-series .li_list").live('click', function(e) {
            ...
            $.getJSON(Yii_jpdataUrl + '/vehicle/goodsYear', {seriesId: seriesId}, function(result) {
                ...
                $('.model_list').show();
                if(iscarcode){
                    $("#ul-year").append('<li class="li_all"><a  href="javascript:void(0)" key="all">不确定年款</a></li>');
                }else{
                    $("#ul-year").append('<li class="li_list"><a  href="javascript:void(0)" key="all">不确定年款</a></li>');
                }
        ...
        $("#ul-year .li_list").live('click', function(e) {
            ...
            $.getJSON(Yii_jpdataUrl + '/vehicle/goodsYearModels', {seriesId: seriesId, year: year}, function(result) {
                ...
                $("#ul-model").empty();
                if(iscarcode){
                    $("#ul-model").append('<li class="li_all"><a  href="javascript:void(0)" key="all">不确定车型</a></li>');
                }else{
                    $("#ul-model").append('<li class="li_list"><a  href="javascript:void(0)" key="all">不确定车型</a></li>');
                }
