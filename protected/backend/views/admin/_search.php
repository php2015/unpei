...
<label  class="control-label">地址:</label>
 <?php
                    ...
                    echo Chtml::dropDownList('User[Province]', $_GET['User']['Province'], $state, array(
                    ...
                    echo Chtml::dropDownList('User[City]', $_GET['User']['City'], $city_update, array(
                    ...
                    echo Chtml::dropDownList('User[Area]', $_GET['User']['Area'], $district_update, array(
                        'class' => 'width90 select',
                        'id' => 'area',
                        'empty' => '请选择地区',
                            )
