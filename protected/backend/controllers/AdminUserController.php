...
//     }
    ...
    public function actionCreate() {
        ...
        if (isset($_POST['AdminUser'])) {
            ...
            $model->PassWord = $model->hashPassword($_POST['AdminUser']['PassWord']);
            
            $model->verifyPassword=$model->hashPassword($_POST['AdminUser']['PassWord']);
...
//            }
              ...
              if ($_POST['AdminUser']['PassWord'] != $oldpassword) {
                $model->PassWord = $model->hashPassword($_POST['AdminUser']['PassWord']);
                  $model->verifyPassword=$model->hashPassword($_POST['AdminUser']['PassWord']);
            }
            if ($model->save())
