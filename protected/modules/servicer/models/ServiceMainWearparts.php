...
/**
 * This is the model class for table "{{service_main_wearparts}}".
 *
 * The followings are the available columns in table '{{service_main_wearparts}}':
 * @property integer $ID
 ...
 * @property string $Car
 */
class ServiceMainWearparts extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ServiceMainWearparts the static model class
	 */
