...
/**
 * This is the model class for table "{{service_main_diagnos}}".
 *
 * The followings are the available columns in table '{{service_main_diagnos}}':
 * @property integer $ID
 ...
 * @property string $Car
 */
class ServiceMainDiagnos extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ServiceMainDiagnos the static model class
	 */
