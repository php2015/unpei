                        ...
                        <li class="nav_i r_ind_nav">
                            ...
                            <div class="nav2">
                                <ul>
                                    ...
                                    <li class="lineh10"><a href="<?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'submit-step3')) ?>">物流代收支付</a><a href="<?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'submit-step7')) ?>">支付宝支付</a></li>
...
<div class="shade"></div>
<div class="info">
     <div  id="x2"  class="submit_s submit_s11" style="display:block"></div>
     <div  class="width1000" style="display:block">
      <div class="light-div submit_light11" >
          <span><a href="javascript:;" class="link next " ><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/newer/下一步.jpg"></a></span>    
      </div>
     </div>

<div class="submit_s submit_s4"></div>
     <div  class="width1000">
      <div class="light-div submit_light4" >
          <span><a href="javascript:;" class="link next" ><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/newer/下一步.jpg"></a></span>    
      </div>
     </div>

<div class="submit_s submit_s5" ></div>
     <div  class="width1000">
      <div class="light-div submit_light5" >
          <span><a href="javascript:;" class="link next" ><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/newer/下一步.jpg"></a></span>    
      </div>
     </div>

<div class="submit_s submit_s12"></div>
     <div  class="width1000">
      <div class="light-div submit_light12" >
        <span><a href="<?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'check-step8')) ?>" class="link next" style="top:10px; left:10px" ><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/newer/下一步.jpg"></a></span>       
      </div>
     </div>
</div>
