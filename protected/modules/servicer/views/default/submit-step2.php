...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
                ...
                <div class="nav fleft">
                    <ul>
                        ...
                        <li class="nav_i ">
                            ...
                            <div class="nav2">
                                <ul>
                                    <li class=""><a href="<?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'newerindex')) ?><?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'newerindex')) ?>">第一步</a></li>
                        ...
                        <li class="nav_i r_ind_nav">
                            ...
                            <div class="nav2">
                                <ul>
                                    ...
                                    <li class="r_i_xuan_z"><a href="<?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'submit-step2')) ?>">第二步</a></li>
        ...
        <div id="x2" class="submit_s submit_s2"></div>

        <div  class="width1000">
            <div class="light-div submit_light2" >
                <span><a href="<?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'submit-step3')) ?>" class="link " style="top:130px;left:30px"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/newer/下一步.jpg"></a></span>    
            </div>
        </div>
