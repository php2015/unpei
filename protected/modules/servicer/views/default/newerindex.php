...
<body>
    ...
    <div class="head">
        <div class="header">
            ...
            <a href="<?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'newerindex')) ?>" class="logo fleft"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/newer/logo.png" /></a>
    ...
    <div class="shade"></div>
    <div id="x2" class="login_s"></div>
    <div  class="width1000">
        <div class="light-div login_light1" >
            <span><a href="<?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'login-step2')) ?>" class="link "><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/newer/下一步.jpg"></a></span>
