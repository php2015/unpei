                ...
                <div class="nav fleft">
                    ...
                    <ul>
                        ...
                        <li class="nav_i r_ind_nav">
                            ...
                            <div class="nav2">
                                <ul>
                                    <li class="r_i_xuan_z"><a href="<?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'check-step1')) ?>">第一步</a></li>
...
<div id="x2" class="check_s check_s1"></div>
<div  class="width1000">
    <div class="light-div check_light1" >
        <span><a href="<?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'check-step2')) ?>" class="link " ><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/newer/下一步.jpg"></a></span>
