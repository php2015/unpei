                        ...
                        <li class="nav_i r_ind_nav">
                            ...
                            <div class="nav2">
                                <ul>
                                    ...
                                    <li class="r_i_xuan_z lineh10"><a href="<?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'submit-step3')) ?>">物流代收支付</a><a href="<?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'submit-step7')) ?>">支付宝支付</a></li>
...
<div class="shade"></div>
 <div id="x2" class="submit_s submit_s6 height850"></div>
 <div  class="width1000">
  <div class="light-div submit_light6" >
   <span><a href="<?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'check-step1')) ?>" class="link " ><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/newer/下一步.jpg"></a></span>
 </div>
 </div>
