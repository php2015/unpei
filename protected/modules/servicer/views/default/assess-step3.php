	...
	<div class="nav fleft">
		 <ul>
                        ...
                        <li class="nav_i">
                            ...
                            <div class="nav2">
                                <ul>
                                    <li class="r_i_xuan_z" ><a href="<?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'choice1')) ?>">方式1：通过商城下单</a></li>
                                    <li><a href="<?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'choice2')) ?>">方式2：通过询价单生成订单</a></li>	
                                </ul>
                            </div>  
                        </li>
                        <!--提交订单-->	
                        <li class="nav_i">
                            ...
                            <div class="nav2">
                                <ul>
                                    ...
                                    <li class="lineh10"><a href="<?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'submit-step3')) ?>">物流代收支付</a><a href="<?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'newerindex')) ?>submit-step7.html">支付宝支付</a></li>
...
<!--                                    <li class="r_i_xuan_z"><a href="<?php // echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'check-step5')) ?>">第五步</a></li>-->
                                </ul>
                            </div>
                        </li>
                        <li class="nav_i r_ind_nav">
                            ...
                            <div class="nav2">
                                <ul>
                                    ...
                                    <li class="r_i_xuan_z"><a href="<?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'assess-step3')) ?>">第三步</a></li>
<!--                                    <li><a href="<?php //echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'assess-step4')) ?>">第四步</a></li>
 ...
 <div id="x2" class="assess_s assess_s3"></div>
 <div  class="width1000">
  <div class="light-div assess_light3" >
<!--      <span><a href="<?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'assess-step4')) ?>" class="link " ><img src="<?php //echo Yii::app()->theme->baseUrl; ?>/images/newer/下一步.jpg"></a></span>    -->
 </div>
     <div class="light-div assess_light4" >
      <span><a href="<?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'return-step1')) ?>" class="link " ><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/newer/下一步.jpg"></a></span>    
 </div>
 </div>
