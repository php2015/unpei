...
<!--                                    <li><a href="<?php //echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'assess-step4')) ?>">第四步</a></li>
        ...
        <div class="info">
            <div id="x2" class="chioce2_s chioce2_s1" style=" display:block"></div>
            <div  class="width1000" style=" display:block">
                <div class="light-div chioce2_light1" >
                    <span><a href="javascript:;" class="link next " ><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/newer/下一步.jpg"></a></span>    
                </div>
            </div>

            <div class="chioce2_s chioce2_s2"></div>
            <div  class="width1000">
                <div class="light-div chioce2_light2" >
                    <span><a href="javascript:;" class="link next " ><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/newer/下一步.jpg"></a></span>    
                </div>
            </div>

            <div class="chioce2_s chioce2_s3"></div>
            <div  class="width1000">
                <div class="light-div chioce2_light3" >
                    <span><a href="javascript:;" class="link next " ><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/newer/下一步.jpg"></a></span>    
                </div>
            </div>


            <div class="chioce2_s chioce2_s4" ></div>
            <div  class="width1000">
                <div class="light-div chioce2_light4" >
                    <span><a href="javascript:;" class="link next " ><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/newer/下一步.jpg"></a></span>    
                </div>
            </div>

            <div class="chioce2_s chioce2_s5"></div>
            <div  class="width1000">
                <div class="light-div chioce2_light5" >
                    <span><a href="javascript:;" class="link next " ><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/newer/下一步.jpg"></a></span>    
                </div>
            </div>

            <div class="chioce2_s chioce2_s6"></div>
            <div  class="width1000">
                <div class="light-div chioce2_light6" >
