...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
                ...
                <div class="nav fleft">
                    <ul>
                        ...
                        <li class="nav_i r_ind_nav">
                            ...
                            <div class="nav2">
                                <ul>
                                    <li class="r_i_xuan_z"><a href="<?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'submit-step1')) ?>">第一步</a></li>
        ...
        <div class="shade"></div>
        <div id="x2" class="submit_s"></div>
        <div  class="width1000">
            <div class="light-div submit_light1" >
                <span><a href="<?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'submit-step2')) ?>" class="link " style="top:200px;right:30px"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/newer/下一步.jpg"></a></span>
