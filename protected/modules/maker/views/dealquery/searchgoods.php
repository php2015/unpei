<div class='content-row-bnm pt10 pb10'>
    <?php echo CHtml::beginForm(Yii::app()->createUrl('maker/dealquery/empgoods',array('dealer'=>$_GET['dealer'])), 'get'); ?>
    <p class=''>
        ...
        <?php echo CHtml::dropDownlist('search[category]',$_GET['search']['category'],CHtml::listData($category,'name','name'),
        		array('class'=>'width118 select','empty'=>'商品类别'))?>
   	  <p class="mt1em">
