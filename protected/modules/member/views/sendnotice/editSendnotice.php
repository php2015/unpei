...
<div class="bor_back m_top10">
    ...
    <div class="txxx_info">
        <div class='form'>
            <form action="<?php echo Yii::app()->createUrl('member/sendnotice/editsave'); ?>" method="post">
                ...
                <div class="txxx_info2 m-top" style="clear:both">
                    ...
                    <div class="float_l " style="width:730px; height:400px; border:1px solid #f0f0f0"> 
                        <textarea style="width:728px; height:398px; border:1px solid #f0f0f0" id="Info" name="Content"><?php echo $data->Content; ?></textarea>
                    </div>
