<div style="float:left;margin-top:20px;overflow-y:scroll;height:320px">
所有联系人：
  <table id="send_car" class="easyui-datagrid" style="width:300px;height:300px"
  data-options="url:'<?php echo Yii::app()->createUrl('cim/contact/contactlist')?>',fitColumns:true,singleSelect:false">
  <thead>
  <tr>
...
<div style="float:left">
    <div> <input id="add" class='btn-sq-add' type="button" name="button" value="&nbsp;&nbsp;&nbsp;&nbsp;" style="cursor:pointer;margin-top:50px"></div>
    <div> <input id="jians" class='btn-sq-remove' type="button" name="button" value="&nbsp;&nbsp;&nbsp;&nbsp;" style="cursor:pointer;margin-top:50px"></div>
    <div> <input id="moreleft" class='btn-sq-all' type="button" name="button" value="&nbsp;&nbsp;&nbsp;&nbsp;" style="cursor:pointer;margin-top:50px"></div>
    <div> <input id="moreright" class='btn-sq-empty' type="button" name="button" value="&nbsp;&nbsp;&nbsp;&nbsp;" style="cursor:pointer;margin-top:50px"></div>
</div>

<div style="float:left;margin-top:20px;overflow-y:scroll;height:320px;">
已添加联系人:
  <table id="select2" class="easyui-datagrid" style="width:300px;height:300px"
  data-options="singleSelect:false">
   ...
   <input type="hidden" id="iddata2" name='iddata'>
