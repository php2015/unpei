...
class Integral extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('OrganID, Integral, CreateTime', 'required'),
			array('OrganID, Integral, CreateTime, UpdateTime, Status', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('ID, OrganID, Integral, CreateTime, UpdateTime, Status', 'safe', 'on'=>'search'),
		);
	}
