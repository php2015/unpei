...
/*	#galleria{
    ...
    .galleria-info-link{
     ...
     .galleria-lightbox-close{color: rgb(68, 68, 68);}
    .galleria-lightbox-prevholder{ z-index:2000000000000;}
    .galleria-lightbox-nextholder{z-index:2000000000000;}
</style>
<?php $url = Yii::app()->params['ftpserver']['visiturl'];?>
<div id="galleria">
	<?php foreach ($imsgs as $element): ?>
    <a href="<?php echo $url .$element['PicPath'];?>">
        <img 
            src="<?php echo $url .$element['PicPath'];?>"
            onerror="javascript:this.src='<?php echo Yii::app()->baseUrl.'/themes/default/images/404.jpg';?>'"
            data-big=""
            data-title="<?php echo $element['PicName'];?>"
            data-description=""
         >
    </a>
    <?php endforeach; ?>  
