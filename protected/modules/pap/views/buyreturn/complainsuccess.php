...
<div class="bor_back m-top" style="height:560px">
    <div class="success upload-success">
        ...
        <div class="float_l m_left20" >
            <b class="success_info"><?php if ($result['success']) { ?>申诉成功！<?php } else { ?>申诉失败<?php } ?></b>
            <?php
            if (!$result['success']) {
                echo "<br/>原因：<b class='success_info'>" . $result['error'] . "</b>";
            }
            ?>
<!--            <p style="line-height:30px" class="m-top"> <span>请选择<a href="<?php echo Yii::app()->createUrl('pap/buyreturn/index', array('Status' => 5)); ?>" style="color:#ff6701">继续申诉</a></span><span class="m_left20"><a href="<?php echo Yii::app()->createUrl('pap/buyreturn/index'); ?>">返回退货单列表</a></span></p>-->

        </div>
        <div style="clear:both"></div>

        <p class="f_weight m-top"  style="font-size:14px; padding-left: 90px"><span class="sec">10</span> 秒后返回退货单列表</p>
...
<script type="text/javascript">
    ...
    function lazyGo() {
        ...
        if (sec > 0)
            ...
            window.location.href = "<?php echo Yii::app()->createUrl('pap/buyreturn/index'); ?>";
    }
    function gotos() {
        window.location.href = "<?php echo Yii::app()->createUrl('pap/buyreturn/index'); ?>";
    }
