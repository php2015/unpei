...
//                        }else {
//                            $image = ReturnorderService::idgetimg($v['GoodsID']);
//                            if ($image) {
//                                $v['ImageUrl'] = $image[0]->ImageUrl;
//                            }
//                        }
                        ?>
                        <li>
            ...
            <div class="float_l   goods_show" style="height:<?php echo $count > 1 ? $count * 150 + 1 : $count * 150 ?>px;min-height:150px">
                ...
                <div class="float_l div_caozuo goods_show2" style="text-align:center; width:135px">
                    <div class="order_caozuo" style="margin-top:40px">
                        <button class="button button2" style="width:65px" onclick="onaudit('<?php echo $data->ID ?>')">申请退货</button>
                    </div>
                </div>
    ...
    <script>
        function onaudit(ID) {  //申请退货
            var url = Yii_baseUrl + '/pap/buyreturn/returngoods/ID/' + ID;
