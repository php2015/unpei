...
<div class="bor_back m-top">              
    ...
    <form method="get" action="<?php //echo Yii::app()->createUrl('pap/buyreturn/addreturn')                                           ?>"> 
        ...
        <p>
            ...
            <label>
                <input type="radio" name="tuihuoRadio" key="tuihuo"value="radio1" checked="checked" dealerID="<?php echo $deid ?>">&nbsp;退货</label>
            <label style="margin-left: 10px">
                <input type="radio" name="tuihuoRadio" key="tuikuan"value="radio2" dealerID="<?php echo $deid ?>" id="tuikuan">&nbsp;无需退货</label>
        </p>
        <br />
        <p>
    ...
    <div id="return_div" style="">
        <!--&nbsp;&nbsp;&nbsp;&nbsp;<button class="button button2" style="width:65px" onclick="apply_return()">批量申请</button>-->
    </div>
</p>
...
<script>
    $(function() {
        ...
        var chexi = '<?php echo Yii::app()->request->getParam('Vehicle') ?>';
        if (!chexi) {
            $("#make-select").val(' ');
        }

        $("#tuikuan").live('click', function() {
            var dealerID = $(this).attr('dealerID');
            var url = Yii_baseUrl + '/pap/buyreturn/addreturn2/id/' + dealerID;
    ...
    function apply_return() {
        ...
        if (len < 1) {
            ...
            window.open(Yii_baseUrl + '/pap/buyreturn/returngoods/ID/' + str);
        }
    }

    function goDealerlist() {
        var url = Yii_baseUrl + '/pap/buyreturn/addsecond';
        window.location.href = url;
    }
