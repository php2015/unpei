...
<?php if ($data->Status < 6 && $data->ComplainStatus == 0): ?>
    <ul class="order_bg" >
        <li class="<?php if ($data->Status == 5) echo 'state'; ?>" style="margin-left: 100px;width:170px;">
...
<div class="bor_back m-top">              
    ...
    <div class="info-box ">
        ...
        <ul class="mjxx m-top">
            ...
            <!--<li>机构地址：<span><?php echo ReturnorderService::getOrganinfo($data->DealerID, 'Address') ?></span></li>-->
...
<script>
    $(document).ready(function() {
        ...
        switch (status) {
            case '1':
                $('i.step-point').css({'left': '42%'});
                break; //审核退货
            case '4':
                $('i.step-point').css({'left': '61%'});
                break; //退货完成
            case '5':
                $('i.step-point').css({'left': '22%'});
                break; //审核未通过
            case '6':
