<style>
 .ui-widget input{ border:1px solid #ccc; height: 23px; line-height: 23px; margin-left:5px} 
 .ui-widget input.submit{ border:none; height: 30px; line-height: 28px } 
