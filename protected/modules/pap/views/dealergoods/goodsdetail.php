...
<p align="right" style="line-height:30px">
    <button class=" button2" onclick="backto()">返回列表</button>
</p>
                    ...
                    <div class="float_l  back_color m_left12 ">
                        <div class="txxx_info3">
                            <?php if ($_GET['status'] != 0): ?>
                                <p>
                                    <span class=" m_left12">当前版本：</span>
                                    <input type="text" class=" input input3 width250" value="<?php echo date('Y-m-d H:i:s', $data->Version) ?>">
                                </p>
                            <?php endif; ?>
                            <p class="m-top">
                                <span class="m_left12">历史版本：</span>
                                <select id="verselect" class='select' style="font-family: 宋体;">
                                    <?php
                ...
                <div class="float_l  back_color m_left12 ">
                    <div class="txxx_info3">
                        <p><span class="color_red" id="GoodsNO_id">&nbsp;</span> <span>商品编号：</span>
                            <input type="text" id="GoodsNO" name="GoodsNO"  class=" input input3 width250" value="<?php echo $data->GoodsNO ?>"></p>
                        <p class="m-top"><span class="color_red" id="Pinyin_id">&nbsp;</span> <span>拼音代码：</span>
                            <input type="text" id="Pinyin" name="Pinyin" id="pinyincode" class=" input input3 width250" value="<?php echo $data->Pinyin ?>" ></p>
                        <p class="m-top">
                            <span  class="m_left12">配件品类：</span>
                            <input id="cpname-search" type="text" class=" input input3 width250" value="<?php echo DealergoodsService::StandCodegetcpname($data->StandCode, 'Name'); ?>"  ></p>
...
//                            $selected = $data->BrandID;
                        ...
                        <div class="m-top" id="showoe"> 
                            <p class="m-top">
                                ...
                                <input type="text"  name="OENOS[]" value="<?php echo $data->goodoe[0]['OENO']; ?>" class=" input input3 width250" onblur="oechange()">
                            ...
                            foreach ($data->goodoe as $key => $val) {
                                if ($key != 0)
                                    echo "<p class='m-top'><input type='text' name='OENOS[]' value='" . $val['OENO'] . "' class='input input3 width250' style='margin-left:81px' onblur='oechange()'></p>";
                            }
                            ?>
                        </div>
...
<span class='showimages'><img  style='width:80px;height:80px;' src="+imgurl+val['ImageUrl']+"><span onclick='xximage(this)' key="+val['ImageUrl']+" class='close icon-close-green xx' name='urlimg' imgname="+val['ImageName']+"></span></span>
...
<!--                            <span class="m_left24a">保修期：</span>   
                        ...
                        <p class="m-top"><span>最小包装数：</span>
                            <input type="text" id="MinQuantity" name="MinQuantity" class=" input input3 width250" value="<?php echo $data->pack->MinQuantity ?>" ></p>
                        <p class="m-top"><span class="color_red" id="Price_id"></span><span class="m_left12a">销售价格：</span>
                            <input type="text" id="Price" name="Price" class=" input input3 width250" value="<?php echo $data->Price ?>"  ></p>
