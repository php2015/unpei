...
class BusinessContacts extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name,customertype,cooperationtype', 'required'),
			array('user_id, jiapart_ID, create_time, update_time', 'numerical', 'integerOnly'=>true),
			...
			array('id, user_id, contact_user_id, jiapart_ID, customertype, cooperationtype, customercategory, name, sex, companyname, phone, province, city, area, address, email, weixin, QQ, memo, create_time, update_time', 'safe', 'on'=>'search'),
		);
	}
