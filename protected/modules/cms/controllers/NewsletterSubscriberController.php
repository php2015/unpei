...
// 	}
	...
	public function actionCreate()
	{
		...
		if (isset($_POST['NewsletterSubscriber'])) {
			...
			if ($model->save()) {
				$this->redirect(array('view','id'=>$model->subscriber_id));
			}
		}
	...
	{
		$dataProvider=new CActiveDataProvider('NewsletterSubscriber');
	 ...
	 * @param NewsletterSubscriber $model the model to be validated
	 */
