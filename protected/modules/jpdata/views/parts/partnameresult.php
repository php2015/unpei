<?php if (Yii::app()->user->Identity == "servicer"): ?>
    <div id="partslist-content" class="checkbox-list" style="width:660px; position:relative  ">
    <?php elseif (Yii::app()->user->Identity == "dealer"): ?>
        <div id="partslist-content" class="checkbox-list" style="width:860px;  ">
        <?php endif; ?>	
        <table style="cellpadding:0; cellspacing:0;" class="partname_table">
            <thead>
                <tr>
                    <th>OE号</th>
                    <th>主组名称</th>
        ...
        <?php if ($count > 50): ?>
            <div style="margin-top:10px;clear:both">
                查询结果太多，部分结果未显示，请输入更精确的配件名称信息！
            </div>
        <?php endif; ?>

        <?php if (Yii::app()->user->Identity == "servicer"): ?>
            <div class="right-box2" style="float: right;display: block;left: 695px; position: absolute;top: 0px;">
                <?php
                if ($arr_oeno) {
