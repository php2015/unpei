...
<div class="bor_back m_top10">
    ...
    <div class="txxx_info">
        <div class='form'>
            ...
            ?>
            <input type="hidden" value="<?php echo $model->PaypalAccount ?>" id="checkvalue">
            <div class='row'>
...
<?php $this->renderpartial('code',array('handle'=>'edit','codename'=>'paypal_code'));?>
<!--内容部分结束-->

<script type="text/javascript">
    $(document).ready(function() {
        $("#save").click(function() {
            if($('.errorMessage:visible').length>0){
                return false;
            }
            if ($('#FinancialPaypal_PaypalAccount').val() != $('#checkvalue').val()) {
                $('#dg').dialog("open");
                return false;
            }
