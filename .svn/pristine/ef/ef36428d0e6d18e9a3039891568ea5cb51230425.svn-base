...
<div class="paysuc" style=" border:3px solid #e1e1e1; height: 350px; background:white; ">           
    ...
    <div class="pay_goods" style="width:55%; height:55px;border-bottom:2px solid #e1e1e1; margin-left: 250px">
        ...
        <br />
        <p><span style="float:left;display:block;width:150px;color:#595959">订单名称:<?php echo $order_info['OrderName']; ?></span><span style="float:left;display:block;width:180px;color:#595959">交易号:<?php echo $notify['trade_no']; ?></span><span style="float:left;display:block;width:150px;color:#595959">订单编号:<?php echo $order_info['OrderSN'] ?></span><a href="<?php echo $redirectUrl; ?>" style="color:#3EB03F">[订单详情]</a></p>
    </div>
