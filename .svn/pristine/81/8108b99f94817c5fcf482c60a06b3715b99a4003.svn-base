...
<div class="bor_back" style="height:600px;width:885px; margin:0 auto;margin-top: 10px">
  <div style="margin:50px 30px">
      <div class="first_line">
         <div class="float_l aim"  style="visibility:hidden">
           <a href="<?php echo Yii::app()->createUrl('jpdata/parts/index')?>"><div class="aim_info">
               <div class="aim_img"><img src="<?php echo F::themeUrl()?>/images/home/images/a2.png"></div>
               <p class="aim_name f_weight">已卖出的商品</p>
           </div>
           </a>
         </div>
           <div class="float_l aim">
           <a href="<?php echo Yii::app()->createUrl('pap/discountset/index')?>"><div class="aim_info">
               <div class="aim_img"><img src="<?php echo F::themeUrl()?>/images/home/images/8.png"></div>
               <p class="aim_name f_weight">营销参数设置</p>
           </div>
           </a>
         </div>
        
         <div class="float_l arrow">
            <p class="aim_wz">为客户设置价格体系</p>
         </div>
         
         <div class="float_l aim">
           <a href=" <?php echo Yii::app()->createUrl('pap/contact/index')?>"><div class="aim_info">
               <div class="aim_img"><img src="<?php echo F::themeUrl()?>/images/home/images/9.png"></div>
               <p class="aim_name f_weight">客户管理</p>
           </div>
           </a>
         </div>
      ...
      <div class="float_l aim "  style="visibility:hidden">
           <a href="<?php echo Yii::app()->createUrl('jpdata/Maintenance/index')?>">
           <div class="aim_info">
               <div class="aim_img"><img src="<?php echo F::themeUrl()?>/images/home/images/17.png"></div>
               <p class="aim_name f_weight">评价管理</p>
           </div>
           </a>
         </div>
      ...
      <!--斜箭头结束-->
       ...
       <div class="first_line">
         <div class="float_l aim">
           <a href="<?php echo Yii::app()->createUrl('pap/promotion/index')?>"><div class="aim_info">
               <div class="aim_img"><img src="<?php echo F::themeUrl()?>/images/home/images/10.png"></div>
               <p class="aim_name f_weight">促销管理</p>
           </div>
           </a>
         </div>
         ...
         <div class="float_l aim">
           <a href=" <?php echo Yii::app()->createUrl('dealer/partner/showrecomincome')?>"><div class="aim_info">
               <div class="aim_img"><img src="<?php echo F::themeUrl()?>/images/home/images/11.png"></div>
               <p class="aim_name f_weight">营销记录</p>
           </div>
           </a>
         </div>
          <div class="float_l arrow" style="visibility:hidden">
      ...
      <div class="float_l aim ">
           <a href="<?php echo Yii::app()->createUrl('dealer/partner/showrecommended')?>">
           <div class="aim_info">
               <div class="aim_img"><img src="<?php echo F::themeUrl()?>/images/home/images/12.png"></div>
               <p class="aim_name f_weight">推荐记录</p>
           </div>
           </a>
         </div>
        <div style="clear:both"></div>
