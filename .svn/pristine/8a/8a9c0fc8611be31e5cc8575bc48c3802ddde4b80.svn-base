                        ...
                        <li class="nav_i r_ind_nav">
                            ...
                            <div class="nav2">
                                <ul>
                                    ...
                                    <li class="r_i_xuan_z"><a href="<?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'check-step4')) ?>">第四步</a></li>
...
<!--                                    <li><a href="<?php //echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'assess-step4')) ?>">第四步</a></li>
 ...
 <div id="x2" class="check_s check_s4"></div>
 <div  class="width1000">
  <div class="light-div check_light4" >
      <span><a href="<?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'assess-step1')) ?>" class="link " ><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/newer/下一步.jpg"></a></span>
