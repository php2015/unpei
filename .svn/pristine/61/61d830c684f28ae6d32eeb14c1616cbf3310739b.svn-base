...
/**
 * This is the model class for table "{{goods_vehicle_relation}}".
 *
 * The followings are the available columns in table '{{goods_vehicle_relation}}':
 * @property integer $ID
 ...
 */
class PapGoodsVehicleRelation extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return PapGoodsVehicleRelation the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('OrganID, GoodsID, Make, Marktxt', 'required'),
			array('OrganID, GoodsID', 'numerical', 'integerOnly'=>true),
			array('Make, Car, Model', 'length', 'max'=>20),
			array('Year, Marktxt, Cartxt, Modeltxt', 'length', 'max'=>64),
