...
<div id="galleria">
    ...
    <a href="<?php echo $element['smallPic'];?>">
        <img 
            src="<?php echo $element['thumbPic'];?>"
            data-big="<?php echo $element['originPic'];?>"
            data-title="<?php echo $element['picTitle'];?>"
            data-description="<?php echo $element['picCaption'];?>"
         >
    </a>
    <?php endforeach; ?>  
</div>
