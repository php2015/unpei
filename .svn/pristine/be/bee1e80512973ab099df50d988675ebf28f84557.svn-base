...
<div class="contents">
    ...
    <div class="content1">
        <div class="content1a float_l">
            ...
            <div id=preview>
                <div class=jqzoom id=spec-n1 >
                    <IMG height=350 src="<?php echo F::uploadUrl() . $r['Images'][0]['ImageUrl'] ?>" jqimg="<?php echo F::uploadUrl() . $r['Images'][0]['ImageUrl'] ?>" width=350>
                </div>
                <div id=spec-n5>
                    ...
                    <div id=spec-list>
                        <ul class=list-h>
                            <?php if ($r['Images']):foreach ($r['Images'] as $v): ?>
                                    <li><img src="<?php echo F::uploadUrl()  . $v['ImageUrl'] ?>"> </li>
                                    <?php
                                endforeach;
                            endif;
                            ?>
        ...
        <div class="content1b float_l">
            ...
            <?php endif; ?>
            <p class="pf">商品评分：<span class="sppf"></span><span class="lanse">（已有<?php echo $r['CommentNo'] ? $r['CommentNo'] : 0 ?>条评价）</span></p>
            <p class="bh">商品编号：<span><?php echo $r['GoodsNO'] ?></span></p>
            <p class="fw">标准名称：<span><?php echo $r['StandCode'] ?></span></p>
            <div>
                <p>适用车型：<input id="make-select"  class="input" type="text" value="<?php echo $makecar ?>"style="width:180px">
        ...
        <div class="content1c float_l">
            ...
            <p class="shop_kf">在线客服：<span><a href="http://wpa.qq.com/msgrd?v=3&uin=1280104105&site=qq&menu=yes;"><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/papmall/lxkf.png"></a></span></p>
                ...
                <div id="tab">
                    ...
                    <div class="tab_box">
                        <div class="spxq">
                            ...
                            <div style="clear:both"></div>
                            <p style="color:#ff5500">特征说明：<?php echo $r['Memo'] ?></p><br/>
