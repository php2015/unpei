...
class ArticleController extends Controller {
	...
	$model = new CmsArticle; // Uncomment the following line if AJAX validation is needed
// $this->performAjaxValidation($model);if (isset($_POST['CmsArticle'])) {
...
// we only allow deletion via POST request
	...
	if (isset($_GET['CmsArticle']))
	    $model->attributes = $_GET['CmsArticle'];$this->render('admin', array(
	    'model' => $model,
	));
    }
