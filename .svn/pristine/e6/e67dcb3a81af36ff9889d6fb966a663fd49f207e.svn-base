                        ...
                        <li class="nav_i  r_ind_nav ">
                            ...
                            <div class="nav2">
                                <ul>
                                    ...
                                    <li class="r_i_xuan_z"><a href="<?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'login-step2')) ?>">第二步</a></li>
                                </ul>
                            </div>
                        </li>
                        <!--挑选商品-->
...
<!--                                    <li><a href="<?php //echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'assess-step4')) ?>">第四步</a></li>
        ...
        <div class="shade"></div>
        <div id="x2" class="login_s login_s2"></div>
        <div  class="width1000">
            <div class="light-div login_light2" >
                <span><a href="<?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'choice1')) ?>" class="link" ><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/newer/下一步.jpg"></a></span>
            </div>
        </div>
