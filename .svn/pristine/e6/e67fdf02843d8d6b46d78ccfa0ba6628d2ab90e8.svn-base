...
class Service extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('userId, ApproveTime, IsPartner, PartnerTime', 'numerical', 'integerOnly'=>true),
			array('UserType, grade', 'length', 'max'=>10),
			array('status, IsBlcak, IsApprove', 'length', 'max'=>2),
                        array('serviceName,serviceFounded,servicePositionCount,serviceTechnicianCount,serviceParkingDigits,serviceCellPhone,serviceEmail,serviceStoreSize,serviceOpenTime','required'),
			...
			array('userId, serviceName, serviceIntro, serviceProvince, serviceCity, serviceArea, serviceAddress, serviceContact, serviceEmail, serviceCellPhone, serviceTelePhone, serviceQQ, serviceFounded, serviceStoreSize, servicePositionCount, serviceTechnicianCount, serviceParkingDigits, serviceOpenTime, serviceReservationMode, serviceRegionProvince, serviceRegionCity, serviceRegionArea, UserType, status, IsBlcak, IsApprove, ApproveTime, jiapartsID, IsPartner, grade, PartnerTime, ServiceType', 'safe', 'on'=>'search'),
		);
	}
