...
<div class='width998 content-row auto_height'>
	<div class='tabs' pre='tab'>
		...
		<a class='active' href='<?php echo Yii::app()->createUrl('/servicer/servicequery/empgoods/dealer/'.$_GET['dealer'])?>'>商品清单</a>
		<?php echo CHtml::link('返回',array('/servicer/servicequery/index'),array("style"=>"float: right"));?>
	</div>
