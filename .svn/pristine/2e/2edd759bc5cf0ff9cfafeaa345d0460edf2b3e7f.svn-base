...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
                        ...
                        <li class="nav_i  r_ind_nav">
                            ...
                            <div class="nav2">
                                <ul>
                                    ...
                                    <li class="r_i_xuan_z"><a href="<?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'return-step7')) ?>">第七步</a></li>
        ...
        <div class="shade"></div>
        <div id="x2" class="return_s return_s7 height900 "></div>
        <div  class="width1000">
            <div class="light-div return_light7"  >
            </div>
            <div class="light-div return_light11"  >
