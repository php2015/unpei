...
<div class="shade"></div>
<div class="info">
     <div  id="x2"  class="submit_s submit_s7"   style="display:block" ></div>
     <div  class="width1000"  style="display:block">
      <div class="light-div submit_light7" >
          <span><a href="javascript:;" class="link next " ><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/newer/下一步.jpg"></a></span>    
      </div>
     </div>

     <div class="submit_s submit_s8" ></div>
     <div  class="width1000">
      <div class="light-div submit_light8" >
          <span><a href="javascript:;" class="link next" ><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/newer/下一步.jpg"></a></span>    
      </div>
     </div>

      <div class="submit_s submit_s9" ></div>
     <div  class="width1000">
      <div class="light-div submit_light9" >
          <span><a href="javascript:;" class="link next" ><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/newer/下一步.jpg"></a></span>   
      </div>
     </div>

      <div class="submit_s submit_s10" ></div>
     <div  class="width1000">
      <div class="light-div submit_light10" >
         <span><a href="<?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'check-step1')) ?>" class="link next"  ><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/newer/下一步.jpg"></a></span>
      </div>
     </div>
