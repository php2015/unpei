...
<div class="bor_back  m-top" style="border:1px solid #cccccc">
    <div class="add_xjd">
        <p class="txxx">&nbsp;&nbsp;选择经销商(双击选择经销商名称)<span class="float_r" style="*margin-top:-35px;margin-right:20px ;">
                <a href="<?php echo Yii::app()->createUrl('/pap/buyreturn/index'); ?>" style="font-weight:400">查看退款(退货)列表</a></span>
        <div>
            <div class="txxx_info cxdw_info" >
                <form method="get" action="<?php echo Yii::app()->createUrl('pap/buyreturn/addsecond2') ?>"> 
...
//                            'header' => '申请退货',
                            ...
                            'buttons' => array(
                                'update' => array(
                                    'label' => '申请',
                                    'url' => 'Yii::app()->createUrl("/pap/buyreturn/addreturn2",array
("id"=>$data[SellerID]))'
                                ),
                            ),
                        ),
