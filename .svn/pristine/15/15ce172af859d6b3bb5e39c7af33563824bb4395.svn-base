                                        ...
                                        if (arr == null) {
                                            ...
                                            if (arr.length > 0) {
                                                for (i = 0; i < arr.length; i++) {
                                                    ...
                                                    html += '<div organ="' + arr[i].id + '" id="' + suggestRow + (i + 1) + '" class="' + cssClass + '"' + id_field + ' seq_id="' + i + '" >' + thumb;
                                                    html += '<div class="suggestion_img"><img src="' + arr[i].img + '"/></div>';
                                                    html += '<div class = "suggestion_title" title = "' + arr[i].data + '" style="width:' + (width - 30) + 'px"> '
                                                    html += arr[i].data.replace(new RegExp('(' + me.textField.val() + ')', 'gi'), "<b>$1</b>") + '</div><div style="clear:both"></div>' + desc + '</div>';
                                                }
