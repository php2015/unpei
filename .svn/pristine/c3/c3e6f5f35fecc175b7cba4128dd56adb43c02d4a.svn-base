...
<div class="auth-module">
	...
	<?php $this->widget('bootstrap.widgets.TbMenu', array(
		...
		'items' => array(
			array(
				'label' => Yii::t('AuthModule.main', '用户'),
				'url' => array('/auth/assignment/index'),
				'active' => $this instanceof AssignmentController,
			),
			array(
				'label' => $this->chinname($this->getItemTypeText(CAuthItem::TYPE_ROLE, true)),
				'url' => array('/auth/role/index'),
				'active' => $this instanceof RoleController,
			),
			array(
				'label' => $this->chinname($this->getItemTypeText(CAuthItem::TYPE_TASK, true)),
				'url' => array('/auth/task/index'),
				'active' => $this instanceof TaskController,
			),
//			array(
//				'label' => $this->chinname($this->getItemTypeText(CAuthItem::TYPE_OPERATION, true)),
