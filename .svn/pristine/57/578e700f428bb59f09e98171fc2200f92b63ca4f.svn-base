...
/**
 * This is the model class for table "{{service_main_repair}}".
 *
 * The followings are the available columns in table '{{service_main_repair}}':
 * @property integer $ID
 ...
 * @property string $Car
 */
class ServiceMainRepair extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return ServiceMainRepair the static model class
	 */
