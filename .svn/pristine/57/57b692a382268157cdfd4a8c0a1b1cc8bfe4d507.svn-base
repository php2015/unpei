 ...
 */
class JpdOrganEmployees extends PAPActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('Birth, DepartmentID, OrganID, CreateTime', 'required'),
			array('Birth, ExpireTime, Phone, DepartmentID, OrganID, CreateTime, UpdateTime, Status', 'numerical', 'integerOnly'=>true),
	 ...
	 * @return JpdOrganEmployees the static model class
	 */
