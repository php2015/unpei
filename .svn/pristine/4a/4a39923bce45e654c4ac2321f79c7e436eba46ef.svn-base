                        ...
                        <li class="nav_i  r_ind_nav">
                            ...
                            <div class="nav2">
                                <ul>
                                    ...
                                    <li class="r_i_xuan_z"><a href="<?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'return-step2')) ?>">第二步</a></li>
...
<div class="shade"></div>
 <div id="x2" class="return_s return_s2"></div>

 <div  class="width1000">
  <div class="light-div return_light2"  >
     <span><a href="<?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'return-step3')) ?>" class="link " ><img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/newer/下一步.jpg"></a></span>  
