...
/**
 * This is the model class for table "{{jp_order_discount}}".
 *
 * The followings are the available columns in table '{{jp_order_discount}}':
 * @property integer $ID
 ...
 */
class JpOrderDiscount extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return JpOrderDiscount the static model class
	 */
