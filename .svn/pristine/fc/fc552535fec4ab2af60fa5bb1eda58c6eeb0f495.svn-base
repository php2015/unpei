  ...
  <div style="margin:50px 30px">
      <div class="first_line">
         <div class="float_l aim" style="visibility:hidden">
          ...
          <div class="float_l aim">
           <a href="<?php echo Yii::app()->createUrl('pap/dealergoods/addinfo1')?>"><div class="aim_info">
               <div class="aim_img"><img src="<?php echo F::themeUrl()?>/images/home/images/a9.png"></div>
               <p class="aim_name f_weight">发布新商品</p>
           </div>
           </a>
         </div>
        
         <div class="float_l arrow" >
            <p class="aim_wz">发布商品</p>
         </div>
         
         <div class="float_l aim" >
           <a href=" <?php echo Yii::app()->createUrl('pap/dealergoods/index')?>"><div class="aim_info">
               <div class="aim_img"><img src="<?php echo F::themeUrl()?>/images/home/images/a11.png"></div>
               <p class="aim_name f_weight">销售中的商品</p>
           </div>
           </a>
         </div>
      ...
      <div class="shu_arrow" >
        <div class="float_l shu_arrow1">
          <p style="text-align:right;margin-right:80px; line-height:80px">添加下架商品</p>
        </div>
          <div class="float_l shu_arrow2" style="margin-left:80px">
          <p style="text-align:left;margin-left:80px; line-height:80px">商品下架</p>
      ...
      <!--斜箭头结束-->
       <div class="first_line">
         <div class="float_l aim" style="visibility:hidden">
          ...
          <div class="float_l aim" style="visibility:hidden">
           <a href="<?php echo Yii::app()->createUrl('pap/buyreturn/addreturn')?>"><div class="aim_info">
               <div class="aim_img"><img src="<?php echo F::themeUrl()?>/images/home/images/1.png"></div>
               <p class="aim_name f_weight">退货申请</p>
           </div>
           </a>
         </div>
           <div class="float_l aim" style="margin-left:20px">
           <a href="<?php echo Yii::app()->createUrl('pap/dealergoods/drop')?>"><div class="aim_info">
               <div class="aim_img"><img src="<?php echo F::themeUrl()?>/images/home/images/a10.png"></div>
               <p class="aim_name f_weight">下架商品</p>
           </div>
           </a>
         </div>
