...
/**
 * This is the model class for table "{{dealer_llegal_record}}".
 *
 * The followings are the available columns in table '{{dealer_llegal_record}}':
 * @property integer $ID
 ...
 */
class LlegalRecordDealer extends CActiveRecord
{
	/**
	 ...
	 * @return DealerLlegalRecord the static model class
	 */
