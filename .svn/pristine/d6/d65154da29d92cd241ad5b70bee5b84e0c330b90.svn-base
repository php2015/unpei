...
<script type="text/javascript" src='<?php echo F::themeUrl(); ?>/js/galleria-1.3.1.min.js'></script>
<script type="text/javascript" src='<?php echo F::themeUrl(); ?>/js/galleria.classic.js'></script>
