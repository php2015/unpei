...
?>
<?php
$this->pageTitle = Yii::app()->name . '-' . '发布询价单';
        ...
        <div>
            <div class="txxx_info cxdw_info" id="inputform">
                <form  id="inquiryform"  onkeypress="if (event.keyCode == 13 || event.which == 13) {
                    ...
                    <p id="VINmdw_info" style="margin-top:10px" > <span class="" style="margin-left: 18px;*margin-left: 15px;margin-left: 15px\9;">VIN码：</span>
                    ...
                    <p id="cxdw_info" style="margin-top:10px"> <span>选择车型：</span>
                        <?php $this->widget('widgets.default.WGoodsModel', array(
                            'scope' => 'epc',
                            'notlink' => 'N',
                            'link' => 'Y',
                            'all' => 'N',
                        ...
                        <span style="color:red" id="changjia_notice">*</span>
                    </p>
                    ...
                    <div class="m-top">
                        ...
                        <a href="javascript:void(0);" class="btn_addPic" style="margin-left:5px"><span id="img_id_one"></span><input type="file" name="upload_file[]" class="filePrew" id="upload_file_one"></a>
                        <a href="javascript:void(0);" class="btn_addPic" ><span id="img_id_two"></span><input type="file" name="upload_file[]" class="filePrew" id="upload_file_two"></a>
                        <a href="javascript:void(0);" class="btn_addPic" ><span id="img_id_three"></span><input type="file" name="upload_file[]" class="filePrew" id="upload_file_three"></a>
                        <a href="javascript:void(0);" class="btn_addPic" ><span id="img_id_four"></span><input type="file" name="upload_file[]" class="filePrew" id="upload_file_four"></a>
                        <a href="javascript:void(0);" class="btn_addPic" ><span id="img_id_five"></span><input type="file" name="upload_file[]" class="filePrew" id="upload_file_five"></a><span style="color:#fb540e">(提示：删除图片双击即可)</span>
                    </div>
                </form>
                <p style="margin-top: 10px;margin-left: 20px" > 
                    ...
                    <span class="add m_left" style="*vertical-align:top;"><a class="jiahao">+</a></span>&nbsp;<a href="javascript:;" class="add_wz" onclick="addCategory()" style="color:#0164c2;*vertical-align:top;">添加</a>
                    <span class="del m_left" style="*vertical-align:top;"><a class=" jiahao jianhao">-</a></span>&nbsp;<a href="javascript:;" class="del_wz" id="removelist" style="color:#ff5400;*vertical-align:top;">移除</a></p>
                <?php
                ...
                ?>
                <p class=" m_top20 m_left65" style="margin-left: 30%;margin-bottom:30px"><input type="button" class="submit f_weight" value="下一步"  id="next"><input  type="button" class=" button4 button3"  value="取消"></p>
                    ...
                    $this->widget('widgets.default.WGridView', array(
                        ...
                        'columns' => array(
                            array(
                                ...
                                'checkBoxHtmlOptions' => array('name' => 'selectdel[]', 'checked' => ""),
                                'selectableRows' => '1',
                                'value' => '$data[ID]'
                            ),
                            array(
                                ...
                                'value' => 'InquiryorderService::addOverflow($data[OrganName],150)'
                            ),
                            array(
                                'name' => '主营车系',
                                 'headerHtmlOptions' => array('width' => '150px'),
                            ...
                            array(
                                ...
                                'type'=>'raw',
                                'value' => 'InquiryorderService::addOverflow(Area::getaddress($data["Province"],$data["City"],$data["Area"]),200)'
                            ),
                        )
                    ));
                    ?>
...
<script type="text/javascript">
                    ...
                    function sendinquiry() {
                        ...
                        _submit = true;
                        $("#inquiryform").form({
                            url: '<?php echo Yii::app()->createUrl('pap/inquiryorder/saveinquiry') ?>',
                    ...
                    function addCategory() {
                        ...
                        var html;
                        html = appendhtml(MainCategory, SubCategory, LeafCategory, jpmall_cpname, jpmall_code);
                        if (!$("#" + jpmall_cpname).val()) {
                            $("#vivle").find('tbody').append(html);
                        }

                    }
                    function appendhtml(MainCategory, SubCategory, LeafCategory, jpmall_cpname, jpmall_code) {
                        var index = 0;
                        ...
                        tmpl += '<tr class="' + rownum + '" id="deltr' + jpmall_cpname + '"><td class="checkbox-column"><input type="checkbox" name="checkbox[]" checkboxid="' + jpmall_cpname + '" code="' + jpmall_code + '"></td>';
                        tmpl += '<td>' + MainCategory + '</td>';
                        tmpl += '<td>' + SubCategory + '</td>';
                        tmpl += '<td>' + LeafCategory + '</td>';
                        tmpl += '<td ><center><div style ="width:150px"><a href="javascript:void(0);" onclick="numdel(' + jpmall_cpname + ')" class="s"></a><input type="text" id="' + jpmall_cpname + '" class="input input5 float_l" style ="width:40px;height:20px;text-align:center" value="1" onblur="checknum($(this).val(),' + jpmall_cpname + ')" name="abc"><a href="javascript:void(0);" class="a" onclick="numadd(' + jpmall_cpname + ')"></a></div></center></td></tr>';
                        return tmpl;
                    }
                    //点击减一
                    function numdel(ID) {
