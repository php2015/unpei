                        ...
                        <li class="nav_i">
                            ...
                            <div class="nav2">
                                <ul>
                                    ...
                                    <li class="lineh10"><a href="<?php echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'submit-step3')) ?>">第三步</a></li>
...
<!--                                    <li><a href="<?php // echo yii::app()->createUrl('servicer/default/newer', array('goto' => 'assess-step4')) ?>">第四步</a></li>
 ...
 <div id="x2" class="check_s check_s5 height980"></div>
 <div  class="width1000">
  <div class="light-div check_light5" > 
