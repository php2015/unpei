...
<div pre="tab" class="tabs">
   ...
   <div class="successmessage" id='message'>
	...
	<?php endif?>
	<div id='modify' style="margin-left:20px; height:500px;">
	  <?php
    $form = $this->beginWidget('CActiveForm', array(
        'id' => 'templatemodify-form',
    ...
    <div class="form">
        <div class="row" style="margin-left: 50px">
            ...
            <?php echo $form->textField($model, 'name', array('class' => 'width113 input','value'=>$result['name'])) ?>
...
<!--             <span class="color-red">*</span> -->
           ...
           <?php echo $form->dropDownList($model, 'system_type',CHtml::listData($parts,'system_type','system_type'),
	                            array('class'=>'widht100 input','empty'=>'请选择系统',
								'ajax' => array(
	                            'type'=>'GET', //request type
								'url'=> Yii::app()->request->baseUrl.'/common/getcpnames',
                                     // 'url'=>Yii::app()->createUrl('maker/templatemanage/getcpname'),
            ...
            <tbody>
                <tr class="form">
                    <td class="row">
                        ...
                        <?php echo $form->textField($model, 'Column1', array('class' => 'width113 input','value'=>$result['Column1'])) ?>
                    </td>
                    <td>
                ...
                <tr class="form">
                    <td class="row">
                        ...
                        <?php echo $form->textField($model, 'Column2', array('class' => 'width113 input','value'=>$result['Column2'])) ?>
                    </td>
                    <td>
               ...
               <tr class="form">
                    <td class="row">
                       <label class="label">参数名3：</label>
                        <?php echo $form->textField($model, 'Column3', array('class' => 'width113 input','value'=>$result['Column3'])) ?>
                    </td>
                    <td>
                ...
                <tr class="form">
                    <td class="row">
                      <label class="label">参数名4：</label>
                        <?php echo $form->textField($model, 'Column4', array('class' => 'width113 input','value'=>$result['Column4'])) ?>
                    </td>
                    <td>
                ...
                <tr class="form">
                    <td class="row">
                      <label class="label">参数名5：</label>
                        <?php echo $form->textField($model, 'Column5', array('class' => 'width113 input','value'=>$result['Column5'])) ?>
                    </td>
                    <td>
...
$('#jpmbk-win #choose').click(function() {
    ...
    checkbox.length > 0 && $('#templatemodify-form .width115').val($('.width669').find('.checkbox-add').text()).after(checkbox);
    $('#cpnameID').val(cpid);
});*/
</script>
