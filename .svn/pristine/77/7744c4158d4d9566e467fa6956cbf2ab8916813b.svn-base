...
$this->breadcrumbs = array(
 ...
 if(empty($model['maker']))$model['maker'] = new Make(); 
		...
		<div class="bor_back m-top">
            ...
            <div class="txxx_info4">
                ...
                <div class="float_l width400 m_left20 gs_info">
                      ...
                      <p><label>年销售额：</label><span><?php echo $model['maker']['SaleMoney']; ?></span></p>
                      <p><label>公司规模：</label><span><?php echo $model['StoreSize']; ?></span></p>
                      <p><label>经营地域：</label><span><?php echo Area::showCity($model['maker']['SaleDomain']); ?></span></p>
                      <p style="word-wrap:break-word; white-space:normal;"><label>机构简介：</label><span><?php echo $model['Introduction']; ?></span></p>
                </div>
            ...
            <div class="m_left80">
             <?php
			    $form = $this->beginWidget('CActiveForm', array(
			        'id' => 'makeformdata',
			    	'action' => Yii::app()->baseurl.'/maker/makecompany/index',
			        'htmlOptions' => array(
...
<script type="text/javascript"><!--
    $(document).ready(function(){
		...
		$("#cancel").click(function(){
			window.location.href = '<?php echo Yii::app()->createUrl("maker/makecompany/index");?>';
		});
        ...
        $("#modify").live('click',function(){
            window.location.href="<?php echo Yii::app()->createUrl('maker/makecompany/index'); ?>/flag/update";
        })
        ...
        $("#save").click(function(){
            ...
            $.getJSON(Yii_baseUrl+'/maker/makecompany/checkorgan',{
                name:name,
        ...
        $("#file_upload").uploadify({
            ...
            'onUploadSuccess':function(file, data, response){//每个文件上传完成时执行的函数 response是服务器返回的数据
                ...
                if(responeseDataObj && responeseDataObj.code == 200){
                    ...
                    var span = "<li><img  style='width:80px;height:80px;' src="+src+"><span id='delfile' keyid="+responeseDataObj.filename+" class='guanbi3'><img src='/themes/default/images/guanbi3.png'></span><input type='hidden' name='goodsImages[]' value="+responeseDataObj.filename+"></li>";
