...
<div class="bor_back m-top">
    <div class="txxx txxx2">
        <ul class="title_lm">
            ...
            <li class="current"><a href="<?php echo Yii::app()->createUrl('pap/orderevaluate/evaluate') ?>">对卖家的服务评价<span class="interval">  |</span></a></li>
            <li><a href="<?php echo Yii::app()->createUrl('pap/orderevaluate/receive') ?>">来自卖家的信用评价<span class="interval">  |</span></a></li>
        </ul>
    </div>
...
//            ),
                array(// display 'author.username' using an expression
                    'name' => '卖家账号',
                    'type' => 'raw',
                    'value' => 'EvaluateService::getOrganName($data[Recier],2)',
                ),
            ),
        ));
        ?>
