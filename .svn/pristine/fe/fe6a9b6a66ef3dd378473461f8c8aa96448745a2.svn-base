(function($) {
    var bigAutocomplete = new function() {
        ...
        this.init = function() {
            $(".sousuo").append("<div id='bigAutocompleteContent' class='bigautocomplete-layout'></div>");
...
//                var str = $(this).find("div:last").html();
//                var strs = new Array();
//                strs = str.split('/');
//                for (i = 0; i < strs.length; i++) {
//                    var text = strs[0];
//                }
                bigAutocomplete.currentInputText.val($(this).find("div:last span").attr('val'));
        ...
        this.autocomplete = function(param) {
                ...
                switch (event.keyCode) {
                    case 40://向下键
                        ...
                        if ($nextSiblingTr.length > 0) {//有下一行时（不是最后一行）
                            ...
                            $this.val($nextSiblingTr.find("div:last span").attr('val'));
                    ...
                    case 38://向上键
                        ...
                        if ($previousSiblingTr.length > 0) {//有上一行时（不是第一行）
                            ...
                            $this.val($previousSiblingTr.find("div:last span").attr('val'));
            ...
            $this.keyup(function(event) {
                ...
                if (!isFunctionalKey && (!ctrl || (ctrl && k == 67) || (ctrl && k == 88))) {
                    ...
                    $bigAutocompleteContent.css({"top": offset.top + h + 6, "left": offset.left - 30});
            ...
            function makeContAndShow(data_) {
                ...
                for (var i = 0; i < data_.length; i++) {
                    cont += "<tr><td><div style='width:100%'>" + data_[i].title + "</div></td></tr>"
                }
                cont += "</tbody></table>";
