        ...
        $("#BLPoto_upload").uploadify({
            ...
            'onUploadSuccess': function(file, data, response) {//每个文件上传完成时执行的函数 response是服务器返回的数据
                ...
                if (responeseDataObj && responeseDataObj.code == 200) {
                    ...
                    var span = "<li><img  style='width:80px;height:80px;' src=" + src + "><span id='delphoto' keyid=" + responeseDataObj.fileurl + " class='guanbi3'><img src='<?php echo F::themeUrl(); ?>/images/guanbi3.png'></span></li>";
