    ...
    <div id="sidebar-nav">
        <?php $this->widget('bootstrap.widgets.TbNav', array(
            ...
            'items' => array_merge(array(
                ...
                array('label' => '分类管理', 'icon' => 'leaf', 'url' => array('/contentcategory/admin')),
                array('label' => '皮肤管理', 'icon' => 'cog', 'url' => array('/theme/admin')),
                array('label' => '语言管理', 'icon' => 'flag', 'url' => array('/language/admin')),
		array('label' => '系统参数管理', 'icon' => 'flag', 'url' => array('/parameter/admin')),
            	array('label' => '缓存管理', 'icon' => 'flag', 'url' => array('/cache/admin')),
            	array('label' => '日志管理', 'icon' => 'flag', 'url' => array('/logger/index')),
