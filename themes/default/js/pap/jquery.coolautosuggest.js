...
(function($) {
                                        ...
                                        if (arr == null) {
                                            ...
                                            if (arr.length > 0) {
                                                for (i = 0; i < arr.length; i++) {
                                                    ...
                                                    html += '<div id="' + suggestRow + (i + 1) + '" class="' + cssClass + '"' + id_field + ' seq_id="' + i + '" >' + thumb + '<div class="suggestion_title">' + arr[i].data + '</div>' + desc + '</div>';
                                                }
        ...
        function checkKey(e) {
            if (me.holder.css("display") != "none") {
                ...
                if (e.keyCode == 40) {
                    ...
                    me.onUpDown.call(this, me.arrData[currRow - 1]);
                }
    ...
    $.fn.coolautosuggest = function(options) {
        ...
        return this.each(function() {
            ...
            if ($.isFunction(settings.onUpDown) == true) {
                obj.onUpDown = settings.onUpDown;
            }
        });
    }
})(jQuery);