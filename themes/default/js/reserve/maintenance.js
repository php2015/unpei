...
$("#front-vehicle-make-list").change(function(){
    ...
    $.ajax({
         ...
         success:function(data){
	         ...
	         if(typeof($('#front-vehicle-make-list').attr('car'))!="undefined"){
	        	 $('#front-vehicle-car-list').val($('#front-vehicle-make-list').attr('car'));
	         }
...
$("#front-vehicle-car-list").change(function()
{
    ...
    $.ajax({
         ...
         success:function(data){
	         ...
	         if(typeof($('#front-vehicle-car-list').attr('engine'))!="undefined"){
	        	 $('#front-vehicle-engine-list').val($('#front-vehicle-car-list').attr('engine'));
	         }
