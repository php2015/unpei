...
<div class="bor_back" style="height:600px;width:885px; margin:0 auto;margin-top: 10px">
  <div style="margin:50px 30px">
      <div class="first_line">
         ...
         <div class="float_l aim">
           <a href=" <?php echo Yii::app()->createUrl('dealer/dealercompany/index')?>"><div class="aim_info">
         ...
         <div class="float_l aim">
           <a href=" <?php echo Yii::app()->createUrl('dealer/mainbusiness/index')?>"><div class="aim_info">
               <div class="aim_img"><img src="<?php echo F::themeUrl()?>/images/home/images/5.png"></div>
               <p class="aim_name f_weight">主营信息管理</p>
           </div>
           </a>
         </div>
      ...
      <div class="first_line">
         ...
         <div class="float_l aim" style="visibility:hidden">
          ...
          <div class="float_l aim" style="margin-left:15px">
