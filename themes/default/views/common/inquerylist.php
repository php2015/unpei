  ...
  <div style="margin:50px 30px">
      <div class="first_line">
         <div class="float_l aim" style="visibility:hidden">
          ...
          <div class="float_l aim">
           <a href="<?php echo Yii::app()->createUrl('pap/inquiryorder/inquiryadd')?>"><div class="aim_info">
               <div class="aim_img"><img src="<?php echo F::themeUrl()?>/images/home/images/a6.png"></div>
               <p class="aim_name f_weight">发布的询价单</p>
           </div>
           </a>
         </div>
        
         <div class="float_l arrow" >
            <p class="aim_wz">新建询价单</p>
         </div>
         
         <div class="float_l aim" >
           <a href=" <?php echo Yii::app()->createUrl('pap/inquiryorder/index')?>"><div class="aim_info">
               <div class="aim_img"><img src="<?php echo F::themeUrl()?>/images/home/images/17.png"></div>
               <p class="aim_name f_weight">询价单管理</p>
           </div>
           </a>
         </div>
      ...
      <div class="first_line">
         <div class="float_l aim" style="visibility:hidden">
          ...
          <div class="float_l aim" style="margin-left:5px">
           <a href="<?php echo Yii::app()->createUrl('pap/quotationlist/index')?>"><div class="aim_info">
               <div class="aim_img"><img src="<?php echo F::themeUrl()?>/images/home/images/a8.png"></div>
               <p class="aim_name f_weight">收到的报价单</p>
           </div>
           </a>
         </div>
         ...
         <div class="float_l aim"  style="visibility:hidden" >
           <a href=" <?php echo Yii::app()->createUrl('jpdata/vehicle/index')?>"><div class="aim_info">
               <div class="aim_img"><img src="<?php echo F::themeUrl()?>/images/home/images/14.png"></div>
               <p class="aim_name f_weight">前市场车型</p>
           </div>
           </a>
         </div>
          <div class="float_l arrow" style="visibility:hidden">
