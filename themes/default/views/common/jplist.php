...
<div class="bor_back" style="height:600px;width:885px; margin:0 auto;margin-top: 10px">
  <div style="margin:50px 30px">
      <div class="first_line">
         <div class="float_l aim">
           <a href="<?php echo Yii::app()->createUrl('jpdata/parts/index')?>"><div class="aim_info">
               <div class="aim_img"><img src="<?php echo F::themeUrl()?>/images/home/images/13.png"></div>
      ...
      <div class="float_l aim ">
           ...
           <div class="aim_info">
               <div class="aim_img"><img src="<?php echo F::themeUrl()?>/images/home/images/16.png"></div>
               <p class="aim_name f_weight">养护周期查询</p>
           </div>
           </a>
         </div>
